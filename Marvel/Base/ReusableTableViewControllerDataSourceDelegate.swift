//
//  ReusableTableViewControllerDataSourceDelegate.swift
//  Marvel
//
...
class MVReusableTableViewController<T, C:UITableViewCell>: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let loadMoreIndicator = UIActivityIndicatorView(style: UIActivityIndicatorView.Style.white)
        loadMoreIndicator.startAnimating()
        self.loadMoreIndicator = loadMoreIndicator
        
        //set up refresh control
        let refreshControl = UIRefreshControl()
        refreshControl.addTarget(self, action: #selector(MVReusableTableViewController.refresh), for: UIControl.Event.valueChanged)
    ...
    @objc func dataWithLimit(limit: Int, offset: Int, completionHandler: @escaping (_ objects:Array<Any>?) -> Void) {
