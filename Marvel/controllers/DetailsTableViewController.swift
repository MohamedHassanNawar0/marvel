    ...
    @IBOutlet weak var headerImageView: UIImageView!
        ...
        didSet {
            if self.character != nil{
                ...
                backButton.setBackgroundImage(#imageLiteral(resourceName: "icn-cell-disclosure"), for: UIControl.State.normal)
...
extension DetailsTableViewController: UICollectionViewDelegateFlowLayout, UICollectionViewDelegate{
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return CGSize(width: storiesContainer.frame.size.width/4, height: storiesContainer.frame.size.height-20)
    }
